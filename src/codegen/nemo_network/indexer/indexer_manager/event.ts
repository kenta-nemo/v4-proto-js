...
export interface IndexerTendermintEventWrapperAminoMsg {
  type: "/nemo_network.indexer.indexer_manager.IndexerTendermintEventWrapper";
...
export interface IndexerEventsStoreValueAminoMsg {
  type: "/nemo_network.indexer.indexer_manager.IndexerEventsStoreValue";
...
export interface IndexerTendermintEventAminoMsg {
  type: "/nemo_network.indexer.indexer_manager.IndexerTendermintEvent";
...
export interface IndexerTendermintBlockAminoMsg {
  type: "/nemo_network.indexer.indexer_manager.IndexerTendermintBlock";
