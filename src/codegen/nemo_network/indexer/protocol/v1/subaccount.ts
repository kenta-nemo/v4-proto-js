...
export interface IndexerSubaccountIdAminoMsg {
  type: "/nemo_network.indexer.protocol.v1.IndexerSubaccountId";
...
export interface IndexerPerpetualPositionAminoMsg {
  type: "/nemo_network.indexer.protocol.v1.IndexerPerpetualPosition";
...
export interface IndexerAssetPositionAminoMsg {
  type: "/nemo_network.indexer.protocol.v1.IndexerAssetPosition";
