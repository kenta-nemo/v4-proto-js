...
export interface OrderbookMessageAminoMsg {
  type: "/nemo_network.indexer.socks.OrderbookMessage";
...
export interface SubaccountMessageAminoMsg {
  type: "/nemo_network.indexer.socks.SubaccountMessage";
...
export interface TradeMessageAminoMsg {
  type: "/nemo_network.indexer.socks.TradeMessage";
...
export interface MarketMessageAminoMsg {
  type: "/nemo_network.indexer.socks.MarketMessage";
...
export interface CandleMessageAminoMsg {
  type: "/nemo_network.indexer.socks.CandleMessage";
...
export interface BlockHeightMessageAminoMsg {
  type: "/nemo_network.indexer.socks.BlockHeightMessage";
