...
export interface OrderPlaceV1AminoMsg {
  type: "/nemo_network.indexer.off_chain_updates.OrderPlaceV1";
...
export interface OrderRemoveV1AminoMsg {
  type: "/nemo_network.indexer.off_chain_updates.OrderRemoveV1";
...
export interface OrderUpdateV1AminoMsg {
  type: "/nemo_network.indexer.off_chain_updates.OrderUpdateV1";
...
export interface OrderReplaceV1AminoMsg {
  type: "/nemo_network.indexer.off_chain_updates.OrderReplaceV1";
...
export interface OffChainUpdateV1AminoMsg {
  type: "/nemo_network.indexer.off_chain_updates.OffChainUpdateV1";
