...
var LCDQueryClient = /** @class */ (function () {
    ...
    /* MarketMapperRevenueShareParams queries the revenue share params for the
     market mapper */
    LCDQueryClient.prototype.marketMapperRevenueShareParams = function (_params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/revshare/market_mapper_rev_share_params";
    ...
    LCDQueryClient.prototype.marketMapperRevShareDetails = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/revshare/market_mapper_rev_share_details/".concat(params.marketId);
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
