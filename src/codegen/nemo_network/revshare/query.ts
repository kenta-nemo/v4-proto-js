...
export interface QueryMarketMapperRevenueShareParamsAminoMsg {
  type: "/nemo_network.revshare.QueryMarketMapperRevenueShareParams";
...
export interface QueryMarketMapperRevenueShareParamsResponseAminoMsg {
  type: "/nemo_network.revshare.QueryMarketMapperRevenueShareParamsResponse";
...
export interface QueryMarketMapperRevShareDetailsAminoMsg {
  type: "/nemo_network.revshare.QueryMarketMapperRevShareDetails";
...
export interface QueryMarketMapperRevShareDetailsResponseAminoMsg {
  type: "/nemo_network.revshare.QueryMarketMapperRevShareDetailsResponse";
