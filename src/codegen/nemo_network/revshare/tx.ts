...
export interface MsgSetMarketMapperRevenueShareAminoMsg {
  type: "/nemo_network.revshare.MsgSetMarketMapperRevenueShare";
...
export interface MsgSetMarketMapperRevenueShareResponseAminoMsg {
  type: "/nemo_network.revshare.MsgSetMarketMapperRevenueShareResponse";
...
export interface MsgSetMarketMapperRevShareDetailsForMarketAminoMsg {
  type: "/nemo_network.revshare.MsgSetMarketMapperRevShareDetailsForMarket";
...
export interface MsgSetMarketMapperRevShareDetailsForMarketResponseAminoMsg {
  type: "/nemo_network.revshare.MsgSetMarketMapperRevShareDetailsForMarketResponse";
