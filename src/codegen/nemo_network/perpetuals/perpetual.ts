...
export interface PerpetualAminoMsg {
  type: "/nemo_network.perpetuals.Perpetual";
...
export interface PerpetualParamsAminoMsg {
  type: "/nemo_network.perpetuals.PerpetualParams";
...
export interface MarketPremiumsAminoMsg {
  type: "/nemo_network.perpetuals.MarketPremiums";
...
export interface PremiumStoreAminoMsg {
  type: "/nemo_network.perpetuals.PremiumStore";
...
export interface LiquidityTierAminoMsg {
  type: "/nemo_network.perpetuals.LiquidityTier";
