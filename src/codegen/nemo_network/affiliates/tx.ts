...
export interface MsgRegisterAffiliateAminoMsg {
  type: "/nemo_network.affiliates.MsgRegisterAffiliate";
...
export interface MsgRegisterAffiliateResponseAminoMsg {
  type: "/nemo_network.affiliates.MsgRegisterAffiliateResponse";
...
export interface MsgUpdateAffiliateTiersAminoMsg {
  type: "/nemo_network.affiliates.MsgUpdateAffiliateTiers";
...
export interface MsgUpdateAffiliateTiersResponseAminoMsg {
  type: "/nemo_network.affiliates.MsgUpdateAffiliateTiersResponse";
