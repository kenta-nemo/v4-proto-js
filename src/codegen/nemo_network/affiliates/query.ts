...
export interface AffiliateInfoRequestAminoMsg {
  type: "/nemo_network.affiliates.AffiliateInfoRequest";
...
export interface AffiliateInfoResponseAminoMsg {
  type: "/nemo_network.affiliates.AffiliateInfoResponse";
...
export interface ReferredByRequestAminoMsg {
  type: "/nemo_network.affiliates.ReferredByRequest";
...
export interface ReferredByResponseAminoMsg {
  type: "/nemo_network.affiliates.ReferredByResponse";
...
export interface AllAffiliateTiersRequestAminoMsg {
  type: "/nemo_network.affiliates.AllAffiliateTiersRequest";
...
export interface AllAffiliateTiersResponseAminoMsg {
  type: "/nemo_network.affiliates.AllAffiliateTiersResponse";
