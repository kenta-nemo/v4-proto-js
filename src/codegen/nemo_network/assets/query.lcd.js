...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.asset = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/assets/asset/".concat(params.id);
    ...
    LCDQueryClient.prototype.allAssets = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "nemo_network/assets/asset";
