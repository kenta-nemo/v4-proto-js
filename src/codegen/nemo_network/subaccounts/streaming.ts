...
export interface StreamSubaccountUpdateAminoMsg {
  type: "/nemo_network.subaccounts.StreamSubaccountUpdate";
...
export interface SubaccountPerpetualPositionAminoMsg {
  type: "/nemo_network.subaccounts.SubaccountPerpetualPosition";
...
export interface SubaccountAssetPositionAminoMsg {
  type: "/nemo_network.subaccounts.SubaccountAssetPosition";
