...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.subaccount = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/subaccounts/subaccount/".concat(params.owner, "/").concat(params.number);
    ...
    LCDQueryClient.prototype.subaccountAll = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "nemo_network/subaccounts/subaccount";
    ...
    LCDQueryClient.prototype.getWithdrawalAndTransfersBlockedInfo = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/subaccounts/withdrawals_and_transfers_blocked_info/".concat(params.perpetualId);
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.collateralPoolAddress = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/subaccounts/collateral_pool_address/".concat(params.perpetualId);
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
