...
export interface QueryMarketsHardCapAminoMsg {
  type: "/nemo_network.listing.QueryMarketsHardCap";
...
export interface QueryMarketsHardCapResponseAminoMsg {
  type: "/nemo_network.listing.QueryMarketsHardCapResponse";
...
export interface QueryListingVaultDepositParamsAminoMsg {
  type: "/nemo_network.listing.QueryListingVaultDepositParams";
...
export interface QueryListingVaultDepositParamsResponseAminoMsg {
  type: "/nemo_network.listing.QueryListingVaultDepositParamsResponse";
