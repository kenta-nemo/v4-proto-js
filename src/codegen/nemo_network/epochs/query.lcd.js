...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.epochInfo = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/v4/epochs/epoch_info/".concat(params.name);
    ...
    LCDQueryClient.prototype.epochInfoAll = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "nemo_network/v4/epochs/epoch_info";
