...
export interface MsgCreateTransferAminoMsg {
  type: "/nemo_network.sending.MsgCreateTransfer";
...
export interface MsgCreateTransferResponseAminoMsg {
  type: "/nemo_network.sending.MsgCreateTransferResponse";
...
export interface MsgDepositToSubaccountResponseAminoMsg {
  type: "/nemo_network.sending.MsgDepositToSubaccountResponse";
...
export interface MsgWithdrawFromSubaccountResponseAminoMsg {
  type: "/nemo_network.sending.MsgWithdrawFromSubaccountResponse";
...
export interface MsgSendFromModuleToAccountResponseAminoMsg {
  type: "/nemo_network.sending.MsgSendFromModuleToAccountResponse";
