...
export interface ListLimitParamsRequestAminoMsg {
  type: "/nemo_network.ratelimit.ListLimitParamsRequest";
...
export interface ListLimitParamsResponseAminoMsg {
  type: "/nemo_network.ratelimit.ListLimitParamsResponse";
...
export interface QueryCapacityByDenomRequestAminoMsg {
  type: "/nemo_network.ratelimit.QueryCapacityByDenomRequest";
...
export interface QueryCapacityByDenomResponseAminoMsg {
  type: "/nemo_network.ratelimit.QueryCapacityByDenomResponse";
...
export interface QueryAllPendingSendPacketsRequestAminoMsg {
  type: "/nemo_network.ratelimit.QueryAllPendingSendPacketsRequest";
...
export interface QueryAllPendingSendPacketsResponseAminoMsg {
  type: "/nemo_network.ratelimit.QueryAllPendingSendPacketsResponse";
