...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.listLimitParams = function (_params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/v4/ratelimit/list_limit_params";
    ...
    LCDQueryClient.prototype.capacityByDenom = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "nemo_network/v4/ratelimit/capacity_by_denom";
    ...
    LCDQueryClient.prototype.allPendingSendPackets = function (_params) {
        if (_params === void 0) { _params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/v4/ratelimit/get_all_pending_send_packet";
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
