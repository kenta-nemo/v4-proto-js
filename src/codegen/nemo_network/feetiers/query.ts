...
export interface QueryPerpetualFeeParamsRequestAminoMsg {
  type: "/nemo_network.feetiers.QueryPerpetualFeeParamsRequest";
...
export interface QueryPerpetualFeeParamsResponseAminoMsg {
  type: "/nemo_network.feetiers.QueryPerpetualFeeParamsResponse";
...
export interface QueryUserFeeTierRequestAminoMsg {
  type: "/nemo_network.feetiers.QueryUserFeeTierRequest";
...
export interface QueryUserFeeTierResponseAminoMsg {
  type: "/nemo_network.feetiers.QueryUserFeeTierResponse";
