...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.params = function (_params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/vault/params";
    ...
    LCDQueryClient.prototype.vault = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/vault/vault/".concat(params.type, "/").concat(params.number);
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    /* Queries all vaults. */
    LCDQueryClient.prototype.allVaults = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "nemo_network/vault/vault";
    ...
    LCDQueryClient.prototype.megavaultTotalShares = function (_params) {
        if (_params === void 0) { _params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/vault/megavault/total_shares";
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.megavaultOwnerShares = function (params) {
        if (params === void 0) { params = {
            pagination: undefined
        }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "nemo_network/vault/megavault/owner_shares";
                        return [4 /*yield*/, this.req.get(endpoint, options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
