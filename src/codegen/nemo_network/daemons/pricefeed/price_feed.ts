...
export interface UpdateMarketPricesRequestAminoMsg {
  type: "/nemo_network.daemons.pricefeed.UpdateMarketPricesRequest";
...
export interface UpdateMarketPricesResponseAminoMsg {
  type: "/nemo_network.daemons.pricefeed.UpdateMarketPricesResponse";
...
export interface ExchangePriceAminoMsg {
  type: "/nemo_network.daemons.pricefeed.ExchangePrice";
...
export interface MarketPriceUpdateAminoMsg {
  type: "/nemo_network.daemons.pricefeed.MarketPriceUpdate";
