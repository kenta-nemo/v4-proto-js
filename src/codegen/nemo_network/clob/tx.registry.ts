...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/nemo_network.clob.MsgProposedOperations", MsgProposedOperations], ["/nemo_network.clob.MsgPlaceOrder", MsgPlaceOrder], ["/nemo_network.clob.MsgCancelOrder", MsgCancelOrder], ["/nemo_network.clob.MsgBatchCancel", MsgBatchCancel], ["/nemo_network.clob.MsgCreateClobPair", MsgCreateClobPair], ["/nemo_network.clob.MsgUpdateClobPair", MsgUpdateClobPair], ["/nemo_network.clob.MsgUpdateEquityTierLimitConfiguration", MsgUpdateEquityTierLimitConfiguration], ["/nemo_network.clob.MsgUpdateBlockRateLimitConfiguration", MsgUpdateBlockRateLimitConfiguration], ["/nemo_network.clob.MsgUpdateLiquidationsConfig", MsgUpdateLiquidationsConfig]];
