...
var LCDQueryClient = /** @class */ (function () {
    ...
    LCDQueryClient.prototype.clobPair = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/clob/clob_pair/".concat(params.id);
    ...
    LCDQueryClient.prototype.clobPairAll = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "nemo_network/clob/clob_pair";
    ...
    LCDQueryClient.prototype.equityTierLimitConfiguration = function (_params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/clob/equity_tier";
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.blockRateLimitConfiguration = function (_params) {
        if (_params === void 0) { _params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/clob/block_rate";
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    LCDQueryClient.prototype.liquidationsConfiguration = function (_params) {
        if (_params === void 0) { _params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var endpoint;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endpoint = "nemo_network/clob/liquidations_config";
                        return [4 /*yield*/, this.req.get(endpoint)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
