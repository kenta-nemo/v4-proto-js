...
export interface QueryNextDelayedMessageIdRequestAminoMsg {
  type: "/nemo_network.delaymsg.QueryNextDelayedMessageIdRequest";
...
export interface QueryNextDelayedMessageIdResponseAminoMsg {
  type: "/nemo_network.delaymsg.QueryNextDelayedMessageIdResponse";
...
export interface QueryMessageRequestAminoMsg {
  type: "/nemo_network.delaymsg.QueryMessageRequest";
...
export interface QueryMessageResponseAminoMsg {
  type: "/nemo_network.delaymsg.QueryMessageResponse";
...
export interface QueryBlockMessageIdsRequestAminoMsg {
  type: "/nemo_network.delaymsg.QueryBlockMessageIdsRequest";
...
export interface QueryBlockMessageIdsResponseAminoMsg {
  type: "/nemo_network.delaymsg.QueryBlockMessageIdsResponse";
